		...
		<ol class="breadcrumb">
			...
			<div class="articles sports">
					...
					<div class="technology">
						<div class="tech-main">
								<c:forEach items="${topArticleList_in_session }" var="article">
							
								<div class="tech" style="padding-left: 10px;padding-right: 10px;">
									<a href="article.htm?id=${article.id }"><img src="images/tech1.jpg" alt="" /></a>
					...
					<div class="article">
						...
						<div class="article-right">
							<div class="article-title">
								<p><fmt:formatDate value="${article.publishTime }" pattern="yyyy-MM-dd"/><a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span>0 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span>104 </a><a class="span_link" href="#"><span class="glyphicon glyphicon-thumbs-up"></span>52</a></p>
				...
				<div class="latest-articles">
							...
							<c:forEach items="${hotArticleList_in_session }" var="article">
								<div class="world-news-grid">
									<img src="images/tech1.jpg" alt="" />
									<a href="single.html" class="title">${article.title } </a>
									<p>${article.intro }</p>
